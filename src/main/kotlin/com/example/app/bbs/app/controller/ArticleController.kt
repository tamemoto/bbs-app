...
class ArticleController {
    ...
    val MESSAGE_ARTICLE_KEY_UNMATCH = "投稿keyが存在しません"
    val MESSAGE_UPDATE_NOMAL = "正常に更新しました"
    val MESSAGE_ARTICLE_DOES_NOT_EXISTS = "対象の記事が見つかりませんでした"
    val MESSAGE_DELETE_NOMAL = "正常に削除できました"
...
//    }
    ...
    fun updateArticle(
        ...
        redirectAttributes.addFlashAttribute("message", MESSAGE_UPDATE_NOMAL)
    ...
    fun deleteArticle(
        ...
        if(!articleRepository.existsById(articleRequest.id)) {
            redirectAttributes.addFlashAttribute("message", MESSAGE_ARTICLE_DOES_NOT_EXISTS)
            redirectAttributes.addFlashAttribute("alert_class", MESSAGE_ARTICLE_KEY_UNMATCH)
            return "redirect:/"
        }
        ...
        redirectAttributes.addFlashAttribute("message", MESSAGE_DELETE_NOMAL)
